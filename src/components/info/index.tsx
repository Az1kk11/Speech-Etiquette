    ...
    return (
        <div className="bio-box">
            ...
            <p>Uteshova Zerne Húrmetillaevna 1982-jılı 26-oktyabrde Nókis qalasında tuwilgan. 2005-jılı Qaraqalpaq mámleketlik universitetin shet tili hám ádebiyatı baģdarın tamamlap, sol jılı Qaraqalpaq mámleketlik universitetiniń Inglis filologiyası kafedrası assistenti lawazımına jumısqa alındı.
                ...
                Ol sırt el hám Respublika kólemindegi jurnallarda basıp shıģarılģan 85 ilimiy tezis hám maqalalar, 12 oqiw qollanba avtorı. Bir neshe márte ilimiy konferenciyalarda bayanatlar menen qatnasqan. Ol Ullı Britaniya mámleketinde (online) hám Özbekistan Respublikası Joqarı hám Orta Arnawlı Bilim Ministrligi, Ozbekstan mámleketlik jáhán tilleri universiteti janındağı kadrlardı qayta tayarlaw
                hám olardıń tajriybesin asırıw orayında tajriybesin asırıw kurslarına qatnasqan. Sonday-aq, Uteshova Zerne Hurmetillaevna hámde shákirti Matmuratova Sarbinaz Azatovna birgelikte shıģargan maqalası ushın 2023-jılı "ILM FAN IFTIXORI" estelik ko'krek nishanları menen siylıqlandı.
            </p>
        </div>
    )
}
